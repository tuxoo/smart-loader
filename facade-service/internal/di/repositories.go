...
func provideUserRepository(db *repository.PostgresDB) repository.IJobRepository {
...
func provideJobStageRepository(db *repository.PostgresDB) repository.IUserRepository {
